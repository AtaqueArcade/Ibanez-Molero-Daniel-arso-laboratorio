...
public interface BookleControlador {
	...
	/**
	 * Método de creación de una actividad. Los parámetros email y descripcion
	 * son opcionales (aceptan valor nulo). El método retorna el id de la nueva
	 * actividad
	 */
	String createActividad(String titulo, String descripcion, String profesor, String email) throws BookleException;

	/**
	 * Método de actualización de la actividad. En relación al método de
	 * creación, añade un primer parámetro con el id de la actividad.
	 */
	...
	/**
	 * Elimina un día de una actividad. El id de la actividad y la fecha
	 * identifican el día.
	 */
	...
	/**
	 * Establece la franja horaria de un turno de una actividad. El primer turno
	 * de un día de actividad es el 1.
	 */
	void setHorario(String idActividad, Date fecha, int indice, String horario) throws BookleException;

	/**
	 * Realiza la reserva de un turno de la actividad. Retorna el identificador
	 * de la reserva.
	 */
